...
export const GlobalStyle = createGlobalStyle`
  :root {
    --light-bg: #F8F8F8; /* Light background from second image */
    ...
    --light-accent-color: #1a73e8; /* Blue for primary actions/links */
    --light-shadow: rgba(0, 0, 0, 0.1);
    --light-inset-shadow: rgba(0, 0, 0, 0.05);

    --dark-bg: #1A2A4A; /* Dark blue from second image */
    ...
    --dark-accent-color: #8AB4F8; /* Lighter blue for dark mode */
...
export const AppWrapper = styled.div`
  ...
  min-height: 100vh;
  background-color: var(--bg); /* Using CSS variable */
...
export const Header = styled.header`
  ...
  .header-left .logo {
    ...
    background: linear-gradient(90deg, #6366f1, #00d4ff, #8a2be2); /* Unique gradient for logo */
...
// Naya component jo left box aur main content ko side-by-side rakhega
export const ContentWrapper = styled.div`
  display: grid;
  grid-template-columns: 220px 1fr;
  margin-top: 60px; /* Header ki height ke barabar margin */
...
export const ContentArea = styled.div`
  ...
  ${(props) =>
    ...
    css`
      padding-right: 340px; // Padding for the right panel to show up
      transition: padding-right 0.3s ease-out;
    `}

  .main-content {
    min-height: calc(100vh - 60px - 4rem); // Header and padding minus
  }
